...
<form class="form-horizontal" action="{{route('updateBerkas', $d->id)}}" method="POST">
            {{ csrf_field() }}
          <div class="box-body">
            <br />
                ...
                <div class="col-sm-10">
                  <select id="agama" class="form-control select2" style="width: 100%;" name="pemohon_id" required>
                    ...
                    @foreach ($pemohon as $s)
                        @if($s->id == $d->pemohon_id)
                        <option value="{{$s->id}}" selected>{{$s->nik}} / {{$s->nama}}</option>
                        @else
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="lat" id="lat" required value="{{$d->lat}}">
                    </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="long" id="long" required value="{{$d->long}}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="luas" required value="{{$d->luas}}">
                </div>
            </div>
                ...
                <div class="col-sm-10">
                  <select id="jenis" class="form-control select2" style="width: 100%;" name="instansi_id">
                        ...
                        @foreach ($instansi as $s)
                            @if($s->id == $d->instansi_id)
                            <option value="{{$s->id}}" selected>{{$s->jenis}}</option>
                            @else
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select id="kelurahan" class="form-control select2" style="width: 100%;" name="kelurahan_id" required>
                            <option value="{{$d->kelurahan_id}}">{{$d->kelurahan->nama}}</option>
                      </select>
                    </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                <input type="text" class="form-control" name="peruntukan" required value="{{$d->peruntukan}}">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">Status</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="status" required value="{{$d->status}}">
                </div>
            </div>
            <div class="form-group">
