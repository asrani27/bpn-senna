...
<div class="alert alert-success alert-dismissible">
    ...
    <h4><i class="icon fa fa-info"></i> Laporan Petugas Ukur</h4>
    Adalah Halaman Untuk Cetak Laporan Data Petugas Ukur.
</div>
<div class="box box-primary">
    <div class="box-body">
        <a href={{route('lap.petugasukur.all')}} class="btn btn-sm btn-primary" target="_blank">Print</a>  
    </div>
</div>
@endsection
