...
<div class="alert alert-success alert-dismissible">
    ...
    <h4><i class="icon fa fa-info"></i> Laporan Berkas Kawasan Pertanian</h4>
    Adalah Halaman Untuk Cetak Laporan Data Berkas Kawasan Pertanian.
</div>
<div class="box box-primary">
    <div class="box-body">
        <a href={{route('lap.pertanian.all')}} class="btn btn-sm btn-primary" target="_blank">Print</a>  
    </div>
</div>
@endsection
