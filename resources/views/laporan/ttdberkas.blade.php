...
<div class="alert alert-success alert-dismissible">
    ...
    <h4><i class="icon fa fa-info"></i> Tanda Terima Berkas</h4>
    Adalah Halaman Untuk Cetak Tanda Terima Berkas Pemohon.
</div>

<div class="box box-primary">
    <div class="box-body">
        <form method="POST" action="{{route('pdfttdberkas')}}" target="_blank">
                {{ csrf_field() }}
