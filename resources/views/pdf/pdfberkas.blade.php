...
<hr />
<p class="auto-style1"><strong>Laporan Berkas : Mulai {{$tglmulai}} sampai {{$tglakhir}} </strong></p>
<table align="left" cellpadding="3" cellspacing="0" class="auto-style2" style="width: 100%">
    <tr>
        <td class="auto-style3"><strong>No</strong></td>
        <td class="auto-style3"><strong>Nomor Berkas</strong></td>
    ...
    <tr>
        ...
        <td class="auto-style7">{{$dt->instansi->jenis}}</td>
