...
<hr />
<p class="auto-style1"><strong>Laporan Arsip</strong></p>
<table align="left" cellpadding="3" cellspacing="0" class="auto-style2" style="width: 100%">
	<tr>
		...
		<td class="auto-style3"><strong>Koordinat</strong></td>
	</tr>
	<?php
	$no = 1;
	?>
	...
	<tr>
		...
		<td class="auto-style7">{{$dt->berkas->pemohon->nama}}</td>
		<td class="auto-style7">{{$dt->berkas->instansi->nama}}</td>
		<td class="auto-style7">{{$dt->berkas->peruntukan}}</td>
		<td class="auto-style7">{{$dt->berkas->kelurahan->kecamatan->nama}}</td>
		<td class="auto-style7">{{$dt->berkas->kelurahan->nama}}</td>
		<td class="auto-style7">{{$dt->berkas->luas}}</td>
		<td class="auto-style7">Lat : {{$dt->berkas->lat}}, Long :{{$dt->berkas->long}}</td>
	</tr>
	@endforeach	
</table>
