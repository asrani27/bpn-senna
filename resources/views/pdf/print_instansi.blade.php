...
<table align="left" cellpadding="3" cellspacing="0" class="auto-style2" style="width: 100%">
	...
	<tr>
		...
		<td class="auto-style7">{{$dt->kode}}</td>
		<td class="auto-style7">{{$dt->nama}}</td>
		<td class="auto-style7">{{$dt->jenis}}</td>
	</tr>
	@endforeach	
</table>
